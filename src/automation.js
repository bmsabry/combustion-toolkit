...
export const AUTO_OUTPUTS = [
  ...
  // ── Card 1 (Flame Speed & Regime Diagnostics) — Bechtold-Matalon + Hawkes-Chen + Bradley ──
  { id: "Le_eff",             label: "Le_eff (B-M Eq.6)", panel: "flame", unit: "—",  pick: r => r.flame?.Le_eff },
  { id: "Le_E",               label: "Le_E (excess)",     panel: "flame", unit: "—",  pick: r => r.flame?.Le_E },
  { id: "Le_D",               label: "Le_D (deficient)",  panel: "flame", unit: "—",  pick: r => r.flame?.Le_D },
  { id: "Ma",                 label: "Markstein (Ma)",    panel: "flame", unit: "—",  pick: r => r.flame?.Ma },
  { id: "Ze",                 label: "Zeldovich (Ze)",    panel: "flame", unit: "—",  pick: r => r.flame?.Ze },
  { id: "delta_F_um",         label: "δ_F (Zeldovich)",   panel: "flame", unit: "μm", pick: r => Number.isFinite(r.flame?.delta_F) ? r.flame.delta_F * 1e6 : null },
  { id: "nu_u",               label: "ν (kinematic visc)", panel: "flame", unit_si: "m²/s", unit_en: "ft²/s", siToEn: m2s_to_ft2s, pick: r => r.flame?.nu_u },
  { id: "ReT_diag",           label: "Re_T (turb)",       panel: "flame", unit: "—",  pick: r => r.flame?.ReT_diag },
  { id: "Ka_diag",            label: "Karlovitz (Ka)",    panel: "flame", unit: "—",  pick: r => r.flame?.Ka_diag },
  { id: "Da_diag",            label: "Da (regime)",       panel: "flame", unit: "—",  pick: r => r.flame?.Da_diag },
  ...
  { id: "pm_tau_hc_ms",       label: "τ_hc' (Plee-Mellor)", panel: "flame", unit: "ms", pick: r => r.flame?.pm_tau_hc_ms },
  { id: "pm_ratio",           label: "τ_sl/τ_hc' (Plee-Mellor LBO line=2.11)", panel: "flame", unit: "—", pick: r => r.flame?.pm_ratio },
  { id: "pm_lbo_safe",        label: "Plee-Mellor LBO Safe", panel: "flame", unit: "bool", pick: r => r.flame?.pm_lbo_safe },
  // ── Card 3 (Premixer Flashback & Autoignition) — 4 gates ──
  { id: "gateA_pass",         label: "Gate A (BLF) Pass",  panel: "flame", unit: "bool", pick: r => r.flame?.gateA_pass },
  { id: "gateA_margin",       label: "Gate A margin (g_actual/g_c_eff)", panel: "flame", unit: "—", pick: r => r.flame?.gateA_margin },
  { id: "Ka_flashback",       label: "Ka_fb (Lieuwen Eq.10.5)", panel: "flame", unit: "—", pick: r => r.flame?.Ka_flashback },
  { id: "g_c_eff",            label: "g_c_eff (confined)", panel: "flame", unit: "1/s", pick: r => r.flame?.g_c_eff },
  { id: "shaffer_T_tip",      label: "T_tip (Shaffer 2013 Eq.4)", panel: "flame", unit_si: "K", unit_en: "°F", siToEn: K_to_F, pick: r => r.flame?.shaffer_T_tip },
  { id: "piCIVB",             label: "Π_CIVB (Sattelmayer)", panel: "flame", unit: "—", pick: r => r.flame?.piCIVB },
  { id: "civb_threshold",     label: "CIVB threshold (H₂-aware)", panel: "flame", unit: "—", pick: r => r.flame?.civb_threshold },
  { id: "gateB_pass",         label: "Gate B (CIVB) Pass", panel: "flame", unit: "bool", pick: r => r.flame?.gateB_pass },
  { id: "v_st_margin",        label: "V_premix/S_T margin", panel: "flame", unit: "—", pick: r => r.flame?.v_st_margin },
  { id: "gateC_pass",         label: "Gate C (Core flashback) Pass", panel: "flame", unit: "bool", pick: r => r.flame?.gateC_pass },
  { id: "tau_res_99_ms",      label: "τ_res,99 (RTD)",     panel: "flame", unit: "ms", pick: r => r.flame?.tau_res_99_ms },
  { id: "ign_margin_card3",   label: "τ_ign/τ_res,99 (need ≥3)", panel: "flame", unit: "—", pick: r => r.flame?.ign_margin_card3 },
  { id: "gateD_pass",         label: "Gate D (Autoignition) Pass", panel: "flame", unit: "bool", pick: r => r.flame?.gateD_pass },
  { id: "card3_status",       label: "Card 3 Overall (4-gate)", panel: "flame", unit: "—", pick: r => r.flame?.card3_status },
];
